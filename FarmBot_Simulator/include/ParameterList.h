...
class ParameterList
{
  ...
  std::fstream EepromSim;

public:
  static ParameterList *getInstance();
  System::String^ writeValue(int id, long value);
  System::String^ readValue(int id);
  ...
  long readValueEeprom(int p_id);
  int writeValueEeprom(int p_id, long p_value);
